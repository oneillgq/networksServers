...
public class DNSServer {
    ...
    private HashMap<Integer, DNSMessage> pending = new HashMap<>();
    ...
    private DatagramPacket handleReply(DNSMessage reply) {
        ...
        var query = pending.get(reply.getID());

        // TODO: add answers to the cache
        cache.storeRecords(reply.getAnswers());

        // TODO: remove the original query from the outstanding set
        pending.remove(reply.getID());
